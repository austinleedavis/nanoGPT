# saves the lichess_uci dataset to a binary file for training. following was helpful:
...
num_proc = 16
dtype = np.uint8  # Currently there are only 23 tokens in the chess LLMs uci vocab
...
if __name__ == "__main__":
    ...
    # Load the dataset
    dataset = load_dataset(dataset_path, data_files=file_path).rename_column("text", "transcript")
